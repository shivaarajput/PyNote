          ...
          <table className="w-full text-left border-collapse min-w-[500px]">
            <thead>
              <tr className="bg-gray-50">
                <th className="border-r border-b border-black p-2 w-20 text-center">
                  S.No.
                </th>
                <th className="border-r border-b border-black p-2 text-center">
                  Name of Experiment
                </th>
                <th className="border-b border-black p-2 w-28 text-center">
                  Sign
                </th>
              </tr>
            </thead>
            ...
            <tbody>
              {currentExperiments.map((exp, index) => (
                ...
                >
                  ...
                  <td className="border-r border-b border-black p-3 font-medium text-blue-900 underline decoration-dotted underline-offset-4 group-hover:text-blue-700">
                    {exp.title}
                  </td>
...
<div className="mt-8 pt-6 border-t border-dashed border-gray-300 relative flex print:hidden">
  ...
  {/* Page Number (TRUE CENTER) */}
  <div className="absolute left-1/2 -translate-x-1/2 text-sm font-semibold text-gray-600">
